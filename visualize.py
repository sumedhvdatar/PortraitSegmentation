...
def store_cropped_image(image_np,pred_np):
...
def display_instances(image, boxes, masks, class_ids, class_names,
    ...
    image1 = cv2.imread('/home/sumedh/Machine Learning/Mask_RCNN/images/cool.jpg', -1)
    resultant = image1.copy()
    image = Image.open('/home/sumedh/Machine Learning/Mask_RCNN/images/cool.jpg')
